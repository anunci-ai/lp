...
const links = {
  ...
  empresa: [
    { label: "Sobre", href: "#" },
    { label: "Blog", href: "#" },
    { label: "Contato", href: "mailto:oi@anuncia.ai" },
  ],
  legal: [
      ...
      <div className="max-w-6xl mx-auto px-5 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            <a href="#" className="flex items-center gap-1 font-bold text-xl mb-4">
              <span className="text-foreground">anuncia</span>
              <span className="gradient-text">.ai</span>
            </a>
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              De foto crua a anúncio que vende.
              <br />
              Em 30 segundos.
            </p>
            {/* Social links */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground/60">
            © {new Date().getFullYear()} anuncia.ai — Todos os direitos reservados.
          </p>
